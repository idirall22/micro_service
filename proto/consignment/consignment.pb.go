...
func (m *Reponse) GetCreated() bool {
	if m != nil {
		return m.Created
	}
	return false
...
func (m *Reponse) GetConsignment() *Consignment {
	if m != nil {
...
func (m *Reponse) GetConsignments() []*Consignment {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*Reponse)(nil), "consignment.Reponse")
...
var fileDescriptor_e5e5ab05dfa973d5 = []byte{
	...
	,
}
...
type ShippingServiceClient interface {
	CreateConsignment(ctx context.Context, in *Consignment, opts ...grpc.CallOption) (*Reponse, error)
	GetConsignment(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*Reponse, error)
}
...
func (c *shippingServiceClient) CreateConsignment(ctx context.Context, in *Consignment, opts ...grpc.CallOption) (*Reponse, error) {
	out := new(Reponse)
...
func (c *shippingServiceClient) GetConsignment(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*Reponse, error) {
	out := new(Reponse)
...
type ShippingServiceServer interface {
	CreateConsignment(context.Context, *Consignment) (*Reponse, error)
	GetConsignment(context.Context, *GetRequest) (*Reponse, error)
}
...
func (*UnimplementedShippingServiceServer) CreateConsignment(ctx context.Context, req *Consignment) (*Reponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateConsignment not implemented")
}
func (*UnimplementedShippingServiceServer) GetConsignment(ctx context.Context, req *GetRequest) (*Reponse, error) {
