...
type ShippingServiceClient interface {
	CreateConsignment(ctx context.Context, in *Consignment, opts ...client.CallOption) (*Reponse, error)
	GetConsignment(ctx context.Context, in *GetRequest, opts ...client.CallOption) (*Reponse, error)
}
...
func (c *shippingServiceClient) CreateConsignment(ctx context.Context, in *Consignment, opts ...client.CallOption) (*Reponse, error) {
...
func (c *shippingServiceClient) GetConsignment(ctx context.Context, in *GetRequest, opts ...client.CallOption) (*Reponse, error) {
...
func (h *ShippingService) CreateConsignment(ctx context.Context, in *Consignment, out *Reponse) error {
	return h.ShippingServiceHandler.CreateConsignment(ctx, in, out)
}

func (h *ShippingService) GetConsignment(ctx context.Context, in *GetRequest, out *Reponse) error {
